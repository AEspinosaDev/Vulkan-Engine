...
class SceneExplorerWidget : public Widget
{
  ...
  protected:
    ...
    void displayObject(Object3D *const obj, int &counter);
  ...
  public:
    ...
    inline void set_scene(Scene *sc)
    {
        m_scene = sc;
    }

    inline Object3D *get_selected_object() const
    {
...
class ObjectExplorerWidget : public Widget
{
  ...
  public:
    ...
    inline Object3D *get_object() const
    {
        return m_object;
    }
    inline void set_object(Object3D *obj)
    {
        m_object = obj;
    }
};
...
class GlobalSettingsWidget : public Widget
{
  ...
  public:
    ...
    inline void set_renderer(Renderer *obj)
    {
        m_renderer = obj;
    }
};
