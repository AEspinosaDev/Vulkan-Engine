...
class PhysicallyBasedMaterial : public IMaterial
{
  ...
  public:
    ...
    PhysicallyBasedMaterial(Vec4 albedo, MaterialSettings params) : IMaterial("physical", params), m_albedo(albedo)
    {
    }
    ...
    inline TextureBase *get_albedo_texture()
    {
        return m_textures[ALBEDO];
    }
    inline void set_albedo_texture(TextureBase *t)
    {
    ...
    */
    inline TextureBase *get_mask_texture()
    {
        return m_textures[MASK_ROUGHNESS];
    }
    inline void set_mask_texture(TextureBase *t, MaskType preset)
    {
    ...
    inline TextureBase *get_roughness_texture()
    {
        return m_textures[MASK_ROUGHNESS];
    }
    inline void set_roughness_texture(TextureBase *t)
    {
    ...
    inline TextureBase *get_metallic_texture()
    {
        return m_textures[METALNESS];
    }
    inline void set_metallic_texture(TextureBase *t)
    {
    ...
    inline TextureBase *get_occlusion_texture()
    {
        return m_textures[AO];
    }
    inline void set_occlusion_texture(TextureBase *t)
    {
