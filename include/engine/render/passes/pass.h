...
class BasePass
{
  protected:
    ...
    virtual void setup_uniforms(std::vector<Graphics::Frame>& frames, const Render::Resources& shared) = 0;
...
#pragma region Core Functions
    virtual void setup(std::vector<Graphics::Frame>& frames, const Render::Resources& shared);

    virtual void execute(const Render::RenderView& view, const Render::Resources& shared) = 0;

    virtual void update_uniforms(const Render::RenderView& view, const Render::Resources& shared) {
    }
