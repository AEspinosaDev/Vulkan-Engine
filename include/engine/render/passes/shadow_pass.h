...
public:
    /*
          ...
          */
    ShadowPass( const ptr<Graphics::Device>& device, const ptr<Render::GPUResourcePool>& shared, const PassLinkage<0, 2>& config, Extent2D extent, uint32_t numLights, ColorFormatType depthFormat )
