...
public:
    /*
        ...
        */
    EnviromentPass( const ptr<Graphics::Device>& device, const ptr<Render::GPUResourcePool>& shared, const PassLinkage<1, 2>& config )
        : BaseGraphicPass( device, shared, { 1, 1 }, 2, CUBEMAP_FACES, false, false, "ENVIROMENT" )
        , m_format( SRGBA_32F )
