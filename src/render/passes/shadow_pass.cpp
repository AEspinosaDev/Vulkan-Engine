// #include <engine/render/passes/shadow_pass.h>

// VULKAN_ENGINE_NAMESPACE_BEGIN
// using namespace Graphics;
// namespace Render {

// void ShadowPass::setup_out_attachments(std::vector<Graphics::AttachmentConfig>& attachments, std::vector<Graphics::SubPassDependency>& dependencies) {

//     attachments.resize(1);

//     attachments[0] = Graphics::AttachmentConfig(m_depthFormat,
//                                                 1,
...
//         new GraphicShaderPass(m_device->get_handle(), m_renderpass, m_imageExtent, GET_RESOURCE_PATH("shaders/shadows/shadows_geom.glsl"));
...
//         new GraphicShaderPass(m_device->get_handle(), m_renderpass, m_imageExtent, GET_RESOURCE_PATH("shaders/shadows/shadows_line_geom.glsl"));
...
// void ShadowPass::execute(Graphics::Frame& currentFrame, Core::Scene* const scene, uint32_t presentImageIndex) {
//     PROFILING_EVENT()
