...
// void FXAAPass::init_resources(VkDevice &device, VkPhysicalDevice &gpu, VmaAllocator &memory, VkQueue &gfxQueue, utils::UploadContext &uploadContext)
// {
...
void FXAAPass::update_uniforms(VmaAllocator &memory)
{
    // struct AuxUniforms{
    //     Vec4 data;
    // };
