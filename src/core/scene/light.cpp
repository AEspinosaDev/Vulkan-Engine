...
Graphics::LightUniforms PointLight::get_uniforms(Mat4 cameraView) const
{
    ...
    uniforms.dataSlot1 = {m_effectArea, m_decaying, (int)m_shadow.type, m_shadow.cast};
    uniforms.dataSlot2 = {m_shadow.bias, m_shadow.kernelRadius, m_shadow.angleDependableBias, m_shadow.softness};
    return uniforms;
}
